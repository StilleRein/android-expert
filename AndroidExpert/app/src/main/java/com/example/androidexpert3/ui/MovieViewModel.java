package com.example.androidexpert3.ui;
...
import com.example.androidexpert3.BuildConfig;
...
public class MovieViewModel extends ViewModel {
    private final ArrayList<String> listGenre = new ArrayList<>();
                                    ...
                                    public void onResponse(JSONObject response) {
                                        try {
                                            ...
                                            for (int i = 0; i < genreList.length(); i++) {
                                                ...
                                                listGenre.add(movieGenre.getString("name"));
                                            }
                                            Movie movies = new Movie(movie, typeName, response, listGenre);
