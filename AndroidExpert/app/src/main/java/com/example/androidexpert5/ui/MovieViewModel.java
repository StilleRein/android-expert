package com.example.androidexpert5.ui;
...
public class MovieViewModel extends ViewModel {
    ...
    public void setMovieFilter(String typeName, String name) {
        final ArrayList<Movie> listItems = new ArrayList<>();

        count = 0;

        String url = "https://api.themoviedb.org/3/search/" + typeName + "?api_key=" + BuildConfig.API_KEY + "&language=en-US&query=" + name;
